...
## [发送对话消息](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#Create-Chat-Message)
...
```
curl -X POST 'http://193.112.190.60/v1/chat-messages' \
...
## [上传文件](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#files-upload)
...
```
curl -X POST 'http://193.112.190.60/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
## [停止响应](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#Stop)
...
```
curl -X POST 'http://193.112.190.60/v1/chat-messages/:task_id/stop' \
...
## [消息反馈（点赞）](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#feedbacks)
...
```
curl -X POST 'http://193.112.190.60/v1/messages/:message_id/feedbacks \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "rating": "like",
...
## [获取下一轮建议问题列表](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#suggested)
...
```
curl --location --request GET 'http://193.112.190.60/v1/messages/{message_id}/suggested?user=abc-123 \
...
## [获取会话历史消息](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#messages)
...
```
curl -X GET 'http://193.112.190.60/v1/messages?user=abc-123&conversation_id=' \
--header 'Authorization: Bearer {api_key}'
```
...
## [获取会话列表](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#conversations)
...
```
curl -X GET 'http://193.112.190.60/v1/conversations?user=abc-123&last_id=&limit=20'\
--header 'Authorization: Bearer {api_key}'
```
...
## [删除会话](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#delete)
...
```
curl -X DELETE 'http://193.112.190.60/v1/conversations/:conversation_id' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{ 
 "user": "abc-123"
...
## [会话重命名](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#rename)
...
```
curl -X POST 'http://193.112.190.60/v1/conversations/:conversation_id/name' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{ 
 "name": "", 
...
## [语音转文字](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#audio)
...
```
curl -X POST 'http://193.112.190.60/v1/audio-to-text' \
--header 'Authorization: Bearer {api_key}' \
...
## [文字转语音](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#audio)
...
```
curl -o text-to-audio.mp3 -X POST 'http://193.112.190.60/v1/text-to-audio' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
...
## [获取应用基本信息](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#info)
...
```
curl -X GET 'http://193.112.190.60/v1/info' \
-H 'Authorization: Bearer {api_key}'
```
...
## [获取应用参数](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#parameters)
...
```
 curl -X GET 'http://193.112.190.60/v1/parameters'\
--header 'Authorization: Bearer {api_key}'
```
...
## [获取应用Meta信息](http://193.112.190.60/app/491fc3da-cfb3-4727-9741-b735a49f9bae/develop#meta)
...
```
curl -X GET 'http://193.112.190.60/v1/meta' \
-H 'Authorization: Bearer {api_key}'
```
